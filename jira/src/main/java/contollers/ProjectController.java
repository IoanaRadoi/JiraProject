...
public class ProjectController implements Serializable {
    ...
    private List<RowTotalPerReleaseSprint> rowsTotalPerReleaseSprint;
    ...
    public void init() {
        ...
        rowsTotalPerReleaseSprint = new ArrayList<>();
    ...
    private void createBarModel2() {
        ...
        barModel2.setTitle("Average per Sprint");
        barModel2.setLegendPosition("ne");

        Axis xAxis = barModel2.getAxis(AxisType.X);
        xAxis.setLabel("Project-Release-Sprint");
    ...
    private BarChartModel initBarModel2() {
        ...
        for(RowTotalPerReleaseSprint total: rowsTotalPerReleaseSprint){
            Long totalSp = Long.valueOf(total.getTotalPerReleaseSprint())/Long.valueOf(total.getSprintCapacity());
            statistics.set(total.getProjectName() + " " + total.getReleaseName() + " " + total.getReleaseYear() + " Sprint " + total.getIdSprint(), totalSp);
        }
    ...
    public void setRowsRaport(List<RowRaport> rowsRaport) {
        ...
        this.rowsTotalPerReleaseSprint = mainController.getProjectRelesesPerReleaseSprintFromStoryPointsSelected(projectsSelectedIds, releasesSelectedIds);
    }
    ...
    public List<RowTotalPerReleaseSprint> getRowsTotalPerReleaseSprint() {
        return rowsTotalPerReleaseSprint;
    }

    public void setRowsTotalPerReleaseSprint(List<RowTotalPerReleaseSprint> rowsTotalPerReleaseSprint) {
        this.rowsTotalPerReleaseSprint = rowsTotalPerReleaseSprint;
    }
